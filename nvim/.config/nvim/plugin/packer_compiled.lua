...
_G.packer_plugins = {
  ...
  ["cmp-vsnip"] = {
    after_files = { "/Users/longhm/.local/share/nvim/site/pack/packer/opt/cmp-vsnip/after/plugin/cmp_vsnip.vim" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-nvim-lsp", "cmp-buffer", "vim-vsnip", "cmp-cmdline", "cmp-dictionary", "cmp-vsnip", "nvim-autopairs" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'indent-blankline.nvim', 'vim-surround', 'nvim-web-devicons', 'nvim-bufferline.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
